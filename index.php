      ...
      <div class="km-navbar-brand text-lg-center">
        <div class="container">
          ...
          <div class="km-navbar-brand-btn-container">
            <a href="indexx.php">LOGIN</a> <a href="signup.php">SIGN UP</a>
          </div>
        </div>
      </div>
	...
	<div id="fw_al_001" class="carousel slide ps_slide_y ps_indicators_y swipe_y ps_easeOutQuint" data-ride="carousel" data-pause="hover" data-interval="5000" data-duration="2500">
		...
		<div class="carousel-inner" role="listbox">
			...
			<div class="carousel-item active">
				...
				<!-- Slide Background -->
				<img src="assets/img/img14.png" alt="fw_al_001_01">
			...
			<div class="carousel-item">
				...
				<!-- Slide Background -->
                <img src="assets/img/img13.png" alt="fw_al_001_02">
			...
			<div class="carousel-item">
				...
				<!-- Slide Background -->
				<img src="assets/img/img15.png" alt="fw_al_001_03">
 ...
 <!-- End -->
    <div class="row product-list">
        <div class="col-sm-6 col-md-4 product-item">
            <div class="product-container">
                <div class="row">
                    <div class="col-md-12"><a class="product-image" href="#"><img src="assets/img/img4.png"></a></div>
                </div>
                <div class="row">
                    <div class="col-8">
        ...
        <div class="col-sm-6 col-md-4 product-item">
            <div class="product-container">
                <div class="row">
                    <div class="col-md-12"><a class="product-image" href="#"><img src="assets/img/img8.png"></a></div>
                </div>
                <div class="row">
                    <div class="col-8">
        ...
        <div class="col-sm-6 col-md-4 product-item">
            <div class="product-container">
                <div class="row">
                    <div class="col-md-12"><a class="product-image" href="#"><img src="assets/img/img6.png"></a></div>
                </div>
                <div class="row">
                    <div class="col-8">
    ...
    <div class="row product-list">
        <div class="col-sm-6 col-md-4 product-item">
            <div class="product-container">
                <div class="row">
                    <div class="col-md-12"><a class="product-image" href="#"><img src="assets/img/img10.png"></a></div>
                </div>
                <div class="row">
                    <div class="col-8">
        ...
        <div class="col-sm-6 col-md-4 product-item">
            <div class="product-container">
                <div class="row">
                    <div class="col-md-12"><a class="product-image" href="#"><img src="assets/img/img9.png"></a></div>
                </div>
                <div class="row">
                    <div class="col-8">
        ...
        <div class="col-sm-6 col-md-4 product-item">
            <div class="product-container">
                <div class="row">
                    <div class="col-md-12"><a class="product-image" href="#"><img src="assets/img/img16.png"></a></div>
                </div>
                <div class="row">
                    <div class="col-8">
    ...
    <div class="row product-list">
        <div class="col-sm-6 col-md-4 product-item">
            <div class="product-container">
                <div class="row">
                    <div class="col-md-12"><a class="product-image" href="#"><img src="assets/img/img7.png"></a></div>
                </div>
                <div class="row">
                    <div class="col-8">
        ...
        <div class="col-sm-6 col-md-4 product-item">
            <div class="product-container">
                <div class="row">
                    <div class="col-md-12"><a class="product-image" href="#"><img src="assets/img/img11.png"></a></div>
                </div>
                <div class="row">
                    <div class="col-8">
        ...
        <div class="col-sm-6 col-md-4 product-item">
            <div class="product-container">
                <div class="row">
                    <div class="col-md-12"><a class="product-image" href="#"><img src="assets/img/img5.png"></a></div>
                </div>
                <div class="row">
                    <div class="col-8">
    ...
    <div class="footer-basic">
        <footer>
            ...
            <div class="text-center"><img class="img-fluid" src="assets/img/meetmefinal.png" style="height: 41px;"><a href="https://www.meetind.me/" target="_blank">
                    <p class="copyright">Bmsce</p>
                </a></div><a href="https://technology.keet.in/" target="_blank">
                <p class="copyright">BMSCE</p>
            </a>
        </footer>
    </div>
    ...
    <script src="assets/js/Product-Slider-3.js"></script>
